...
public class DnDTabbedPane extends JTabbedPane {
  ...
  public DnDTabbedPane() {
    ...
    final DragSourceListener dsl = new DragSourceListener() {
      @Override public void dragEnter(final DragSourceDragEvent e) {
        e.getDragSourceContext().setCursor(DragSource.DefaultMoveDrop);
      }
      @Override public void dragExit(final DragSourceEvent e) {
        e.getDragSourceContext().setCursor(DragSource.DefaultMoveNoDrop);
        lineRect.setRect(0,0,0,0);
        glassPane.setPoint(new Point(-1000,-1000));
        glassPane.repaint();
      }
      @Override public void dragOver(final DragSourceDragEvent e) {
      ...
      @Override public void dragDropEnd(final DragSourceDropEvent e) {
        lineRect.setRect(0,0,0,0);
        dragTabIndex = -1;
      ...
      @Override public void dropActionChanged(final DragSourceDragEvent e) {}
    };
    final Transferable t = new Transferable() {
      private final DataFlavor FLAVOR = new DataFlavor(
          DataFlavor.javaJVMLocalObjectMimeType, NAME);
      @Override public Object getTransferData(final DataFlavor flavor) {
      ...
      @Override public boolean isDataFlavorSupported(final DataFlavor flavor) {
        return flavor.getHumanPresentableName().equals(NAME);
      }
    };
    final DragGestureListener dgl = new DragGestureListener() {
      @Override public void dragGestureRecognized(final DragGestureEvent e) {
        if(getTabCount() <= 1) {
            return;
        }
  ...
  class CDropTargetListener implements DropTargetListener{
    @Override public void dragEnter(final DropTargetDragEvent e) {
    ...
    @Override public void dragExit(final DropTargetEvent e) {}
    @Override public void dropActionChanged(final DropTargetDragEvent e) {}
    ...
    @Override public void drop(final DropTargetDropEvent e) {
  ...
  private int getTargetTabIndex(final Point glassPt) {
    final Point tabPt = SwingUtilities.convertPoint(
  ...
  private void initTargetLeftRightLine(final int next) {
    if(next < 0 || dragTabIndex==next || next-dragTabIndex==1) {
      ...
      final Rectangle r = SwingUtilities.convertRectangle(
  ...
  private Rectangle getTabAreaBounds() {
    ...
    final Rectangle compRect = (comp==null)?new Rectangle():comp.getBounds();
    final int tabPlacement = getTabPlacement();
    if(tabPlacement==TOP) {
